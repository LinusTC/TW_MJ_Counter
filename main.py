...
if __name__ == "__main__":
    ...
    Thirteen_waist_test = {'m1': 1, 'm9':1, 's1': 1, 's9':1, 't1': 1, 't7':0, 't8':4, 't9':2, 'east': 1, 'south': 1, 'west': 1, 'north': 1, 'zhong': 1, 'fa': 1, 'bai':1}
    ...
    deck_validator = DeckValidator(Thirteen_waist_test)
