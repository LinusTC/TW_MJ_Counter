...
if __name__ == "__main__":
    ...
    joker_test = {'joker':2, 'm1': 1, 'm9':1, 's1': 1, 's9':1, 't1': 0, 't7':1, 't8':1, 't9':2, 'east': 1, 'south': 1, 'west': 1, 'north': 1, 'zhong': 1, 'fa': 1, 'bai':1}
    ...
    for test_name, test_tiles in tests.items():
        ...
        full_counter = FullCounter(test_tiles, winner_seat, curr_wind, 'm1', False, True, 0, 1)
